...
fun wordLadderII(beginWord: String, endWord: String, wordList: MutableCollection<String>): List<List<String>> {
...
fun main(args: Array<String>) {
    println(wordLadderII("hit", "cog", mutableListOf("hot", "dot", "dog", "lot", "log")))
}